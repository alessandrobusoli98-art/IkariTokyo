...
const products = [
  ...
  { id:'ts-2', color:'white',  name:'Gojo — Honored One', series:'Jujutsu Kaisen',         cat:'tshirt', price:35, imgB: P+'ts-gojohonored-B.png',    imgW: P+'ts-gojohonored-W.png',   sizes:['XS','S','M','L','XL','XXL'], desc:'Il momento più discusso della saga. La HONORED ONE tee cattura l\'istante in cui la maschera cade e rimane solo la verità — un design sobrio e devastante ispirato alla scena che ha spaccato in due una fanbase intera.<br><br>Chi era davvero il più forte.' },
